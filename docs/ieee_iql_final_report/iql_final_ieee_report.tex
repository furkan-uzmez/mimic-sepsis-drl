...
Aksiyonların ayrık binler olarak modellenmesi üç nedenle tercih edilmiştir. Birincisi, MIMIC-IV gibi gözlemsel yoğun bakım verilerinde sürekli doz uzayının her bölgesi yeterli destek içermez; ayrık binleme, düşük destekli doz bölgelerinde ekstrapolasyon riskini azaltır. İkincisi, IV sıvı ve vazopresör kararlarının $5\times5$ grid olarak tanımlanması AI Clinician ve takip eden sepsis RL literatürüyle karşılaştırılabilirlik sağlar. Üçüncüsü, IQL ve OPE bileşenleri için davranış politikası olasılıklarının ve aksiyon frekanslarının güvenilir tahmini ayrık aksiyon uzayında daha kararlıdır. Bu nedenle sürekli doz tahmini yerine klinik olarak yorumlanabilir, destek denetimi yapılabilir ve sızıntısız biçimde öğrenilen ayrık tedavi binleri kullanılmıştır.
